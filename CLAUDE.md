...
**議事録は `共通/ミーティング/` 配下。3周年・イベント・集客・特典・ウェビナー連携について聞かれたら、まず以下を読むこと：**
- `共通/ミーティング/2026-07-02_3周年定例MTG.md`（定例：戦略・新町タスク集約）
- `共通/ミーティング/2026-07-03_3周年イベントMTG_フロント連携キックオフ.md`（フロント×コミュニティ集客連携：金額6000円/アンカリング・2軸ファネル・目標2000/外部200・当日ブース構成）
